...
int main() {
    ...
    const int starting_seed = 50;
    const int time_min = 1;
    const int time_max = 100;
    const int slowdown_little_min = 1;
    const int slowdown_little_max = 5;
    const std::vector<int> num_tasks_possible = {80, 100, 120, 140, 160};
    const std::vector<double> stateless_ratios = {0.2, 0.5, 0.8};
    const std::vector<std::tuple<int, int>> resources = {{100,100}, {120,120}, {140,140}, {160,160}};
    std::vector<std::string> algorithms = {"HeRAD", "FERTAC", "OTAC_big"};
    const std::string results_file = "performance_results_large.csv";
