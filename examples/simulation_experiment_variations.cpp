...
int main() {
   // Parameters
    ...
    const std::string scenario_file = "simulation_scenarios_variations.csv";
    const std::string results_file = "simulation_results_variations.csv";
    ...
    {
        const int number_of_seeds = 1000;
        const int starting_seed = 2000;
        const int num_tasks = 20;
        const int time_max = 100;
        const std::vector<std::tuple<int, int>> resources = {{32, 8}, {20, 20}, {8, 32}};
